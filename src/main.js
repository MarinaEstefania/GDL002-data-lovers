...
document.getElementById("p1").value = document.write(" Km necesarios para eclosionar huevo: ", POKEMON.pokemon[0].egg);
document.getElementById("p1").value = document.write(" Posibilidad de que aparezca: ", POKEMON.pokemon[0].spawn_chance);
document.getElementById("p1").value = document.write(" Promedio de apariciones: ", POKEMON.pokemon[0].avg_spawns);
document.getElementById("p1").value = document.write(" Tiempo que tarda en aparecer: ", POKEMON.pokemon[0].spawn_time);
document.getElementById("p1").value = document.write(" Multipliers: ", POKEMON.pokemon[0].multipliers);
document.getElementById("p1").value = document.write(" Debil contra Pokemon tipo: ", POKEMON.pokemon[0].weaknesses);
document.getElementById("p1").value = document.write(" Siguiente evolución: ", POKEMON.pokemon[0].next_evolution[0].name);
document.getElementById("p1").value = document.write(" Siguiente evolución: ", POKEMON.pokemon[0].next_evolution[1].name);
*/
